...
% %     edging
%     a0 = imcrop(a,[20 300 2500 1000]);
%     a1 = imadjust(a0, [0.2 0.7], [0 1]);
%     bw = edge(a0,'canny', thresh);
%     a2 = combine_image(a0, bw);
%     aa = trace_image(a1,bw);
%     outputFilename = strcat('Processed_ndl14_h4_r1_',num2str(ii, '%05g'),ext);
%     saveas(gcf,[OutputDir,outputFilename]);
% %     edging
%   fitting circles
...
%     outputFilename = strcat('Circled_ndl14_h4_r1_',num2str(ii, '%05g'),ext);
%     saveas(gcf,[OutputDir,outputFilename]);
%   fitting circles
